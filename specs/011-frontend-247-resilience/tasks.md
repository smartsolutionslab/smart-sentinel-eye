...
- [x] T027 Execute quickstart.md §§1–4 end-to-end against the Aspire stack and record the observations (per-SC pass/fail, console `[resilience]` excerpts) as the Phase-5 verification note for the PR

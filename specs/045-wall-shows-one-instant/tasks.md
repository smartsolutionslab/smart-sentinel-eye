...
- [x] T018 [P] [US2] `tests/Integration.Tests/StreamDistribution/` — the endpoint accepts both new names; an unknown name is still refused and the message names all four; a **non-kiosk** principal sending either is accepted and dropped (`IsBrowserKiosk()`, #1893).

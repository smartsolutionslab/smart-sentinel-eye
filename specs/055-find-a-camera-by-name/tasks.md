...
- [x] T011 [US1] Add the same filter to `apps/management-web/src/features/cameras/CamerasPage.tsx`, reusing whatever T010 produces rather than writing a second one.

...
public static class LayoutCompositionApiModule
{
    public static IServiceCollection AddLayoutCompositionApi(this IServiceCollection services)
    {
        ...
        services.AddScoped<CreateWallCommandHandler>();
        services.AddScoped<EditWallScenesCommandHandler>();
        services.AddScoped<SwitchWallSceneCommandHandler>();
        services.AddScoped<GetWallQueryHandler>();
        services.AddScoped<ListWallsQueryHandler>();

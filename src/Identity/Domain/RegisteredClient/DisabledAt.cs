...
/// </para>
/// </summary>
public sealed record DisabledAt(DateTimeOffset Value) : IValueObject<DateTimeOffset>, IComparable<DisabledAt>
{
    /// <summary>
    ...
    /// </summary>
    public int CompareTo(DisabledAt? other) =>
        other is null ? 1 : Value.CompareTo(other.Value);

    public static bool operator <(DisabledAt left, DisabledAt right) =>
        Comparer<DisabledAt>.Default.Compare(left, right) < 0;

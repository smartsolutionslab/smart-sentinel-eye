...
/// </para>
/// </summary>
public sealed record RejectedAt(DateTimeOffset Value) : IValueObject<DateTimeOffset>, IComparable<RejectedAt>
{
    /// <summary>
    ...
    /// </summary>
    public int CompareTo(RejectedAt? other) =>
        other is null ? 1 : Value.CompareTo(other.Value);

    public static bool operator <(RejectedAt left, RejectedAt right) =>
        Comparer<RejectedAt>.Default.Compare(left, right) < 0;

...
/// <summary>
/// When the integration last moved onto a new credential.
///
/// <para>
...
/// </para>
/// </summary>
public sealed record RotatedAt(DateTimeOffset Value) : IValueObject<DateTimeOffset>, IComparable<RotatedAt>
{
    /// <summary>
    ...
    /// </summary>
    public int CompareTo(RotatedAt? other) =>
        other is null ? 1 : Value.CompareTo(other.Value);

    public static bool operator <(RotatedAt left, RotatedAt right) =>
        Comparer<RotatedAt>.Default.Compare(left, right) < 0;
    ...
    public static RotatedAt From(DateTimeOffset value) =>
    ...
    /// access (<c>x.RotatedAt.Value</c>) does not translate and falls back to
    /// client evaluation, which passes tests while scanning the table.
    /// </summary>
    public static implicit operator DateTimeOffset(RotatedAt value) => value.Value;

...
// issue #2333, plan.md §6.3). One per app (management-web here), for the
// reason spec 257 plan.md §5.3 gives: two configs, two chances to wire it
// wrong. Identical to kiosk-web's copy except for this comment and the
// describe title.
//
...
describe('management-web built output self-hosts IBM Plex (spec 261 US1/US2/US3)', () => {

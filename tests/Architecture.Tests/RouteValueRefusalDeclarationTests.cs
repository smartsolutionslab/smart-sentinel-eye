...
public class RouteValueRefusalDeclarationTests
{
    ...
    public void The_api_sources_use_only_the_string_and_comment_forms_this_reader_can_mask()
    {
        ...
        offenders.ShouldBeEmpty(
            ...
            + "becomes the rest of the file, and this mapping is credited with every later mapping's 400 "
            + "refusal declaration. Keep the form out of src/*/Api, or teach SourceMask to read it — a "

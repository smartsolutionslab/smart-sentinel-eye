...
public class PreconditionDeclarationTests
{
    ...
    public void The_api_sources_use_only_the_string_and_comment_forms_this_reader_can_mask()
    {
        ...
        string[] offenders = FormsThisReaderCannotMask(files.Select(file => (
            file,
        ...
        offenders.ShouldBeEmpty(
            ...
            + "becomes the rest of the file, and this mapping is credited with every later mapping's 428 "
            + "and 400 declarations. Keep the form out of src/*/Api, or teach SourceMask to read it — a "

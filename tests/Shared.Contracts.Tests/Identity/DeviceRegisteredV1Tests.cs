...
public class DeviceRegisteredV1Tests
{
    ...
    public void Exposes_every_field_via_the_positional_constructor()
    {
        ...
        DeviceRegisteredV1 evt = new(id, "plc-station-4", "plc", "station-4", "munich", Moment);
    ...
    public void Implements_IIntegrationEvent_so_Wolverine_can_route_it() =>
        new DeviceRegisteredV1(Guid.CreateVersion7(), "x", "plc", "s", "f", Moment)
    ...
    {
        Guid id = Guid.CreateVersion7();
        DeviceRegisteredV1 a = new(id, "x", "plc", "s", "f", Moment);
        DeviceRegisteredV1 b = new(id, "x", "plc", "s", "f", Moment);
        a.ShouldBe(b);
    ...
    public void JSON_round_trip_preserves_every_field()
    {
        DeviceRegisteredV1 original = new(
            Guid.CreateVersion7(), "plc-station-4", "plc", "station-4", "munich", Moment);

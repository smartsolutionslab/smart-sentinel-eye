...
- Name: fixture-source-literal.spec.ts >> fixture: an unlabelled password field embeds its typed value with no accessible name
- Location: scripts\fixtures\trace-redaction\fixture-source-literal.spec.ts:157:5
...
```yaml
- textbox [active] [ref=e2]: SSE_FAKE_PASSWORD_VALUE
```
